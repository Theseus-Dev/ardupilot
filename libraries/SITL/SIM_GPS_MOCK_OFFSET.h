...
private:
    ...
    // Distance tracking for random offset feature
    double _last_lat, _last_lon;  // Last position for distance calculation
    double _cumulative_distance;  // Total distance traveled in meters
    double _random_offset_lat, _random_offset_lon;  // Current random offset
    bool _distance_tracking_initialized;  // Whether we've set initial position
